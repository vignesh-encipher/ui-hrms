...
export default function EmployeesPage() {
  ...
  const handleBulkUpload = async (info: any) => {
    ...
    try {
      ...
      message.success(
        `Bulk upload completed: ${res.data.successCount} successful, ${res.data.failCount} failed.`,
      );
      loadData();
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      if (editingEmployee) {
        ...
        message.success({
          content:
            "Employee account created successfully. The employee can now log in using their email address and the assigned password.",
          duration: 6,
        });
      }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            >
              <Select
                ...
                options={[
                  {
                    value: "",
                    label: "No Manager (Top-Level Employee / CEO / Head)",
                  },
                  ...managers.map((m) => {
                    const desigTitle =
                ...
                return currentStatus && currentStatus !== "Active" ? (
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please select the resignation / exit date!",
                      },
                    ]}
                  >
                    <DatePicker
        ...
        {viewingEmployee && (
          ...
          >
            ...
            <Descriptions.Item label="Designation">
              {viewingEmployee.designationTitle || "-"}
            </Descriptions.Item>
            <Descriptions.Item label="Manager">
              {viewingEmployee.managerName || "None"}
            </Descriptions.Item>
            ...
            {viewingEmployee.resignationDate && (
              <Descriptions.Item label="Resignation / Exit Date">
                {viewingEmployee.resignationDate}
              </Descriptions.Item>
            )}
      ...
      >
        ...
        >
          <div>
            <p>
              1. Download the Excel template below to structure your data
              correctly:
            </p>
          ...
          {bulkResult && (
            ...
            >
              ...
              >
                ✓ Created Successfully: {bulkResult.successCount}
              </p>
              <p
                style={{
                  color: "#dc2626",
