...
import { Card, Row, Col, Button, Table, List, Space, Modal, Form, Input, Select, message, DatePicker, Tabs, Descriptions } from 'antd';
...
export default function LeavesPage() {
  ...
  const [selectedHrRequest, setSelectedHrRequest] = useState<LeaveRequest | null>(null);
  ...
  const tabItems = [
    ...
    },
    {
      ...
      children: (
        <Card title="Pending Approvals Workflow" bordered={false} style={{ borderRadius: '24px' }}>
          <Table
            size="small"
            dataSource={pendingRequests.filter(req => {
              ...
              },
              {
                ...
                render: (_: any, req: LeaveRequest) => {
                  ...
                  const canApproveCurrentStage =
                    (currentLvl === 1 && (isManagerUser || req.level1ApproverId === employeeId)) ||
